...
let multiLinkedList2 = buildMultiLevel(nodes2);
let multiLinkedList3 = buildMultiLevel(nodes3);
...
console.log('after flatten');
printList(flatten(multiLinkedList2));

console.log('after flatten');
printList(flatten(multiLinkedList3));
